...
var thirdHero1 = heroes.slice(1,2);
var thirdHero = thirdHero1.toString();
...
var doubleTheFun = function(param){
	return( Number(param) + Number(param) || param + param);
};
...
var getValueOfProperty = function(obj, key){
	return(obj[key]);
};
